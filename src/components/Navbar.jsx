...
export default function Navbar({ isNavOpen, setIsNavOpen, isNavFloating, toggleNav, closeNav, lenisRef }) {
  ...
  return (
    <>
      ...
      <div id="nav-links" className={`fixed top-0 left-0 w-[100vw] h-[100dvh] bg-white z-[50] flex flex-col items-center justify-center gap-8 transition-all duration-500 ease-in-out min-[992px]:hidden ${isNavOpen ? "mobile-menu-active" : "mobile-menu-inactive"}`}>
        {navLinks.map((link) => (
