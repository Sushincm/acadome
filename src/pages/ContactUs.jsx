         ...
         <div className="container max-w-[800px] mx-auto">
            ...
            <div className="flex justify-center gap-6">
               {['Instagram', 'Facebook'].map((social) => (
                  <a 
                    key={social} 
                    href={social === 'Instagram' ? "https://www.instagram.com/acadome.in" : "https://www.facebook.com/profile.php?id=61562893422409&name=xhp_nt__fb__action__open_user&_rdr"} 
                    target="_blank"
                    rel="noopener noreferrer"
                    className="w-12 h-12 bg-white rounded-full flex items-center justify-center shadow-md hover:bg-accent-red hover:text-white transition-all transform hover:-translate-y-1"
                  >
